...
public class SecurityConfig {
   ...
   public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
      ...
      http.authorizeHttpRequests(authorize -> authorize // 페이지 접근에 관한
            ...
            .requestMatchers(mvc.pattern("/category/**"), mvc.pattern("/search/**"), mvc.pattern("/question/**"),mvc.pattern("/question/questionCreate/**"),
            ...
            //.oauth2Login(oauth2 -> oauth2.loginPage("/login").defaultSuccessUrl("/").failureUrl("/login/error")
