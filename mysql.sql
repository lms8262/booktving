...
-- book_review 데이터 삽입
insert into book_review(book_review_id, content, book_id, member_id) values(1, "너무 유익한 책이었습니다. 추천합니다.", 1, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(2, "너무 유익한 책이었습니다. 추천합니다.", 2, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(3, "너무 유익한 책이었습니다. 추천합니다.", 3, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(4, "너무 유익한 책이었습니다. 추천합니다.", 4, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(5, "너무 유익한 책이었습니다. 추천합니다.", 5, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(6, "너무 유익한 책이었습니다. 추천합니다.", 6, 1);
insert into book_review(book_review_id, content, book_id, member_id) values(7, "너무 유익한 책이었습니다. 추천합니다.", 7, 1);
